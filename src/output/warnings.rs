        ...
        match *self {
            ...
            Warnings::SlowInitialRun(time_first_run, ref options) => write!(
                ...
                hints = match (options.warmup_in_use, options.prepare_in_use) {
                    (true, true) =>
                        "You are already using both the '--warmup' option as well \
                    ...
                    count.",
                    (true, false) =>
                        "You are already using the '--warmup' option which helps \
                    ...
                    (false, true) =>
                        "You are already using the '--prepare' option which can \
                    ...
                    (false, false) =>
                        "You should consider using the '--warmup' option to fill \
